...
exports.sendCategoryEmail = async (req, res) => {
    ...
    // console.log("is this the text:", emailMessage.text );
    //   console.log("is this the text:",  accommodation.accomCatId.emailMessage.text ); 
    //   console.log("is this the text:", accomCatId.emailMessage.text ); 
    ...
    try {
      ...
      // console.log("here's the email 1:", db.accomCat.email); 
      // console.log("here's the email :", req.body.email); 
    //  console.log("here's the email 2:", accomCats.email); 
      console.log("here's the email 3:", accommodation.accomCat.email); 
    //  console.log("here's the email 4:", accommodation.email); 
      // Retrieve the email address associated with the category
  ...
  exports.getEmailDetails = async (req, res) => {
    try {
        ...
        const accommodation = await db.accommodation.findOne({ where: 
          { accomCatId: accomCatId }, 
          include: [
            {
              model: db.accomCat, // Join with Category table
              as: "accomCat",
        ...
        if (!accommodation) {
            return res.status(404).json({ message: "Accommodation category not found" });
        }
